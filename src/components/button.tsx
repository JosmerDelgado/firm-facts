...
interface ButtonProps {
  ...
  showIcon?: (props: React.SVGProps<SVGSVGElement>) => React.JSX.Element;
  disabled?: boolean
}
...
export const Button = ({
  ...
  const Icon = showIcon;
  return (
    <button className={cx(style["base-button"], {[style.default]: variant === ButtonVariant.default})} disabled={disabled}>
      ...
      {variant === ButtonVariant.default && children}
    </button>
  );
};
